...
describe("Histogram", () => {
  ...
  it("cvtDither", () => {
    ...
    expect(dump(dst0d)).toBe(
      "00 00 00 00 01 00 01 01 01 01 01 01 02 01 02 02 02 02 02 02 03 02 03 03 03 03 03 03 04 03 04 04"
    );
    expect(dump(dst1d)).toBe(
      "00 00 00 05 00 05 05 05 05 05 05 06 05 06 06 06 06 06 06 07 06 07 07 07 07 07 07 08 07 08 08 08"
    );
  });
});
